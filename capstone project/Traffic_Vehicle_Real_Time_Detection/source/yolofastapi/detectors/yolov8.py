...
class YoloV8ImageObjectDetection:
    PATH        = os.environ.get("YOLO_WEIGHTS_PATH", r"C:\Users\chris\Desktop\capstone project\Traffic_Vehicle_Real_Time_Detection\runs\detect\train\weights\best.pt")    # Path to a model. yolov8n.pt means download from PyTorch Hub
